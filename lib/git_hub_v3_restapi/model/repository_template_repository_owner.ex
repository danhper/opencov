...
defmodule GitHubV3RESTAPI.Model.RepositoryTemplateRepositoryOwner do
  @moduledoc """
...
defimpl Poison.Decoder, for: GitHubV3RESTAPI.Model.RepositoryTemplateRepositoryOwner do
