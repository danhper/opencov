...
defmodule GitHubV3RESTAPI.Model.Repository do
  @moduledoc """
  A git repository
  """
  ...
  @type t :: %__MODULE__{
          ...
          :forks => integer(),
          :permissions => GitHubV3RESTAPI.Model.RepositoryPermissions.t() | nil,
          ...
          :template_repository => GitHubV3RESTAPI.Model.RepositoryTemplateRepository.t() | nil,
...
defimpl Poison.Decoder, for: GitHubV3RESTAPI.Model.Repository do
  ...
  def decode(value, options) do
    ...
    |> deserialize(:permissions, :struct, GitHubV3RESTAPI.Model.RepositoryPermissions, options)
    |> deserialize(:owner, :struct, GitHubV3RESTAPI.Model.SimpleUser, options)
    |> deserialize(
      :template_repository,
      :struct,
      GitHubV3RESTAPI.Model.RepositoryTemplateRepository,
      options
    )
  end
end
